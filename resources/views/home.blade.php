...
<div class="container">
    ...
    <div class="card mb-3">
        <div class="card-body">
            ...
            <p class="card-text"><small class="text-muted">Posted by {{ $post->user->name }} on {{
            ...
            <form action="{{ route('comments.store') }}" method="POST" class="mt-2">
                ...
                <div class="form-group">
                    ...
                    <textarea name="body" id="comment-{{ $post->id }}" class="form-control" rows="2"
                        required></textarea>
                </div>
                <br>
        ...
        <div class="card-footer">
            ...
            <div class="card mt-2">
                <div class="card-body">
                    ...
                    <p class="card-text"><small class="text-muted">Commented by {{ $comment->user->name }} on {{
                            $comment->created_at->format('Y-m-d') }}</small></p>
                    @can('update', $comment)
